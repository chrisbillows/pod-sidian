...
class TrackedJsonManager:
    ...
    def load_latest_json(self) -> Dict[str, Any]:
        '''
    ...
    def write_blank_json(self) -> None:
        '''
    ...
    def get_current_json(self) -> Dict[str, Any]:
        ...
        if no_current_json:
            self.write_blank_json()  # also updates metafile 
        current_tracked_json = self.load_latest_json()
